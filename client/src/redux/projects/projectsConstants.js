...
import explorer from '../../assets/jpeg/explorer-min.jpg';
    ...
    eng: [
      {
        ...
        image: explorer,
        name: 'Explorer',
        description: 'SpaceX Launch Planner.',
        techStack:
        ...
        date: new Date('August 28, 2020 06:24:00'),
        url: 'https://explorer-s.herokuapp.com/',
        active: true,
        color: '#0090e6',
      },
      {
        ...
        techStack:
          'Front side of the application realized by React.js, state managed using context api. Express serves static content, both client and server utilizes Socket.IO lib to realize real time built in chat.',
    ...
    rus: [
      {
        ...
        image: explorer,
        name: 'Explorer',
        description: 'Планировщик запусков SpaceX.',
        techStack:
          'Основная особенность приложения - анализировать планетарные данные, собранные космическим телескопом Кеплер, чтобы найти планеты, которые могут содержать жизнь, на основе определенных показателей, таких как (масса звезды, радиус звезды, радиус планеты), а также мы можем просматривать и планировать запуски SpaceX с использованием SpaceX API.',
        date: new Date('August 28, 2020 06:24:00'),
        url: 'https://explorer-s.herokuapp.com/',
        active: true,
        color: '#0090e6',
    ...
    ukr: [
      {
        ...
        image: explorer,
        name: 'Explorer',
        description: 'Планувальник запусків SpaceX.',
        techStack:
          'Основна особливість додатка - аналізувати планетарні дані, зібрані космічним телескопом Кеплер, щоб знайти планети, які можуть містити життя, на основі певних показників, таких як (маса зірки, радіус зірки, радіус планети), а також ми можемо переглядати і планувати запуски SpaceX з використанням SpaceX API.',
        date: new Date('August 28, 2020 06:24:00'),
        url: 'https://explorer-s.herokuapp.com/',
        active: true,
        color: '#0090e6',
